...
export const timeline = [
  ...
  { year: "2015", label: "Cooperativa de treball associat", desc: "Transport, transformació social, web i comunicació" },
  { year: "2019", label: "Cistelles Ecològiques", desc: "Hort per subscripció, cultiu transparent" },
...
export const services = [
  {
    ...
    description: "Gestió integral per a comunitats de propietaris i administradors de finques. Coordinació tècnica, seguiment i interlocució amb industrials.",
  ...
  },
  {
    ...
    description: "Instal·lador autoritzat. Residencial i indústria, inclosa la legalització i la gestió d'ajuts.",
    tags: ["Autoritzat", "Residencial", "Legalització"],
    accent: "warm",
  },
  {
    icon: "Code2",
    title: "Tecnologia per a pimes",
    description: "Apps, automatitzacions i eines d'IA a mida. Solucions concretes per a problemes concrets.",
